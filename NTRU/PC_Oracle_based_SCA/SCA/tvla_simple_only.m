...
path = '/Users/pace/Dropbox/NTU/Programs/Lattice_programs/My_codes/NTRU_work/SCACCAONNTRU/NTRU/PC_Oracle_based_SCA/SCA/Pre_Processing_Phase/';

% We have traces captured for a total of 44 different ciphertexts...
% The 44th ciphertext is the base ciphertext...
% Testing TVLA between traces_0 and traces_x for x in
% [start_rep_file_count,rep_file_count]
% rep_file_count = 44 corresponds to base ciphertext whose TVLA is very
